...
const projects = [
  ...
  },
  {
    id: 2,
    name: "Music Fest",
    description: "An interactive music festival website with dynamic animations, where users can discover artist profiles and check concert schedules—including when and where performances take place.",
    tech: ["Html", "CSS"],
