    ...
    return (
        <div className="relative overflow-clip min-h-screen text-white bg-[linear-gradient(to_bottom,#000,#340F41_35%,#8A3DA4_55%,#B993ED_85%)]">
            <div className="absolute bg-black w-[2400px] h-[1000px] rounded-[50%] left-1/2 -translate-x-1/2
                            bg-[radial-gradient(closest-side,#000_85%,#9E4AC5)] top-[450px] border-[#BD8CDE]/30" />
                ...
                <div className="flex flex-col items-center justify-center text-center z-10">
                    ...
                    >
                        ...
                        <Image 
                            src={profilepic}
                            alt="profie pic"
                            className="w-[250px] relative z-10 rounded-2xl"
                        />
                    ...
                    >
                        <h1 className="text-6xl text-white/80 max-w-lg mx-auto leading-relaxed mb-6">
                            Hi, I am <br/> Great <span className="text-purple-300">Efekodo</span>
                        </h1>
                        <p className="text-xl text-white/80 max-w-lg mx-auto leading-relaxed mb-4">I am a fullstack developer focusing on creating websites that provides user with best experience</p>
